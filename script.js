...
searchBtn.addEventListener("click", getMealListAll);
    ...
    fetch(`https://www.themealdb.com/api/json/v1/1/filter.php?i=${searchInputTxt}`)
        ...
        .then(data => {
            ...
            if (data.meals) {
                ...
                html = "Wait or again click or full food name plz.if you full name search here,therefore this item not found.";
            }
            mealList.innerHTML = html;
        })
}
